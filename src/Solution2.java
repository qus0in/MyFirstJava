public class Solution2 {
    public static void main(String[] args) {
        ...
        long i2 = 9_999_999_999L; // 뒤에 L이 붙으면 Long 타입
        System.out.println(i2); // Shift + F10
        // 실수 자료형 (소숫점을 포함한)
        float f = 1.5f; // 상대적으로 짧은 소수점 표시
        float f2 = 1.555555555f; // 일정 이상의 소수점 표현 X (끊어서 저장됨)
        ...
        // https://www.phind.com/search?cache=48bad92d-b8f3-49d5-aa08-c0f2a3a19007
        // 사칙연산
        ...
        System.out.println(f4); // 0.6666666666666666
        int n7 = n1 % n2;
        ...
        System.out.println("[n8] " + n8); // 10
        // n1 = 11
        int n9 = n1--; // n1 = n1 - 1;
        // 일단 n1을 n9에 대입하고, n1에다가 1을 빼주고 그걸 다시 n1에 대입해주세요.
        System.out.println("[n9] " + n9); // 11
        // n1 = 10
        int n10 = ++n1; // n1 = n1 + 1; - 증가 연산을 하고 나서 대입...
        System.out.println("[n10] " + n10); // 11
        int n11 = --n1; // n1 = n1 - 1; - 감소 연산을 하고 나서 대입...
        System.out.println("[n11] " + n11); // 10
